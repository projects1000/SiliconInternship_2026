...
import { AttendanceComponent as Mem5AttendanceComponent} from './member5/attendance/attendance.component';
...
import { ChatWindowComponent as Mem3ChatWindowComponent} from './member3/chat-window/chat-window.component';

import { BillingSystemComponent } from './member3/billing-system/billing-system.component';
import { ProductListComponent as Mem3ProductListComponent} from './member3/product-list/product-list.component';
...
@NgModule({
  declarations: [
    ...
    Member9Component,
    Member10Component,
    Mem5AttendanceComponent,
    Mem3ChatWindowComponent,
