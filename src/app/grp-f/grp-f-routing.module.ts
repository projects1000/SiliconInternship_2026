...
import { Member5ChatWindowComponent } from './member5/member5-chat-window/member5-chat-window.component';
...
const routes: Routes = [
  ...
  { path: 'member2/member2-attendance', component: Member2AttendanceComponent },
  { path: 'member2/attendance-history', component: AttendanceHistoryComponent },
  { path: 'member2/product-management', component: ProductDashboardComponent },
  { path: 'member2/whatsapp-chat', component: WhatsappChatDashboardComponent },

  { path: 'member3', component: Member3Component },
  { path: 'member3/attendance-project', component: AttendanceProjectComponent },
  { path: 'member3/whatsapp-chat', component: WhatsappChatComponent },
  { path: 'member3/billing-system', component: BillingSystemComponent },

  { path: 'member4', component: Member4Component },
  { path: 'member4/attendance', component: Member4AttendanceComponent },
  { path: 'member4/billing', component: Member4BillingComponent },
  { path: 'member4/notification', component: NotificationComponent },
  { path: 'member4/product-list', component: Member4ProductListComponent },
  { path: 'member4/product-management', component: ProductManagementComponent },
  { path: 'member4/footer', component: FooterComponent },
  { path: 'member4/login', component: LoginComponent },
  { path: 'member4/product-detail/:id', component: ProductDetailComponent },
  { path: 'member4/cart', component: CartComponent },
  { path: 'member4/checkout', component: CheckoutComponent },
  { path: 'member4/student-a', component: StudentAComponent },
  { path: 'member4/student-b', component: StudentBComponent },
  { path: 'member4/chat-window', component: ChatWindowComponent },

  { path: 'member5', component: Member5Component },
  { path: 'member5/attendance', component: Member5AttendanceComponent },
  { path: 'member5/member5-chat-window', component: Member5ChatWindowComponent },
  ...
  { path: 'member7/attendance', component: Member7AttendanceComponent },
  { path: 'member7/chat', component: ChatComponent },

  { path: 'member8', component: Member8Component },
  { path: 'member9', component: Member9Component },
  { path: 'member10', component: Member10Component },
  { path: 'member10/chatapp', component: Member10ChatAppComponent },
  { path: 'member10/attendance-dashboard', component: Member10AttendanceDashboardComponent },
  { path: 'member10/billing', component: Member10BillingComponent },
];
