...
export class Member10AttendanceDashboardComponent  implements OnInit {
  ...
  members: Member[] = [
    ...
    { name: 'Ravi Kumar',      group: 'Group F', attendance: {} },
    { name: 'Sneha Patra',     group: 'Group F', attendance: {} },
    { name: 'Amit Das',        group: 'Group A', attendance: {} },
    { name: 'Priya Singh',     group: 'Group B', attendance: {} },
    { name: 'Rahul Nayak',     group: 'Group C', attendance: {} },
  ];
